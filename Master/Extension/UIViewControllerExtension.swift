...
extension UIViewController {
    ...
    func presentIOSAlertWarning(message: String, completion: @escaping () -> Void) {
        let title = NSAttributedString(string: "Alert", attributes: [NSAttributedString.Key.font : UIFont.init(name: Constant.Fonts.fontOne, size: 15.0)!, NSAttributedString.Key.foregroundColor : #colorLiteral(red: 0.08911790699, green: 0.08914073557, blue: 0.08911494166, alpha: 1)])
        ...
        let doneAction = UIAlertAction.init(title: "Ok", style: .cancel) { (action) in
            completion()
        }
    ...
    func presentCDAlertWarningAlert(message: String, completion: @escaping () -> Void) {
        let alert = CDAlertView(title: "Alert", message: message, type: CDAlertViewType.notification)
        alert.titleFont = UIFont(name: Constant.Fonts.fontOne, size: 15)!
        alert.messageFont = UIFont(name: Constant.Fonts.fontOne, size: 13)!
        let done = CDAlertViewAction.init(title: "Ok", font: UIFont(name: Constant.Fonts.fontOne, size: 15)!, textColor: UIColor.darkGray, backgroundColor: .white) { (alert) -> Bool in
            completion()
            return true
        }
    ...
    func presentCDAlertWarningWithTwoAction(message: String, buttonOneTitle: String, buttonTwoTitle: String, handlerButtonOne: @escaping () -> Void, handlerButtonTwo: @escaping () -> Void) {
        ...
        alert.titleFont = UIFont(name: Constant.Fonts.fontOne, size: 15)!
        alert.messageFont = UIFont(name: Constant.Fonts.fontOne, size: 13)!
        let buttonOne = CDAlertViewAction.init(title: buttonOneTitle, font: UIFont(name: Constant.Fonts.fontTwo, size: 15)!, textColor: UIColor.darkGray, backgroundColor: .white) { (alert) -> Bool in
            handlerButtonOne()
            return true
        }
        let buttonTwo = CDAlertViewAction.init(title: buttonTwoTitle, font: UIFont(name: Constant.Fonts.fontTwo, size: 15)!, textColor: UIColor.darkGray, backgroundColor: .white) { (alert) -> Bool in
            handlerButtonTwo()
            return true
        }
...
extension UIViewController {
    ...
    func toggleSideMenu() {
        ...
        let sideNav = mainStoryboard.instantiateViewController(withIdentifier: "LeftMenuNavigationController") as! SideMenuNavigationController
    ...
    private func sideSetting() -> SideMenuSettings {
        ...
        settings.menuWidth = (UIScreen.main.bounds.width/3)*1.8
...
extension UIViewController {
    func addToNav() -> UINavigationController {
        let defaultNavigation = UINavigationController.create(withId: "DefaultNavigationController") as! UINavigationController
        defaultNavigation.viewControllers.append(self)
