...
@objc protocol CollectionViewCellDelegate {
    @objc optional func button1Tapped(sender: UIButton, cell:CollectionViewCell)
    @objc optional func button2Tapped(sender: UIButton, cell:CollectionViewCell)
    @objc optional func button3Tapped(sender: UIButton, cell:CollectionViewCell)
    @objc optional func button4Tapped(sender: UIButton, cell:CollectionViewCell)
    @objc optional func switch1ValueChanged(sender: UISwitch, cell:CollectionViewCell)
    @objc optional func switch2ValueChanged(sender: UISwitch, cell:CollectionViewCell)
}
