...
@objc protocol TableViewCellDelegate {
    ...
    @objc optional func stepperValueChanged(sender: UIStepper,cell:TableViewCell)
...
class TableViewCell: UITableViewCell {
    ...
    @IBAction func stepperValueChanhed(_ sender: Any) {
        delegate?.stepperValueChanged?(sender: sender as! UIStepper, cell: self)
    }
